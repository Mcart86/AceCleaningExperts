...
<section style="background:var(--gray);" id="areas">
  <div class="wrap area-row">
    ...
    <img src="/images/south-jersey-badge.webp" alt="Proudly Serving South Jersey badge" class="area-badge">
  </div>
</section>
...
<section>
  <div class="wrap">
    <div class="feature-row">
      ...
      <div class="feature-visual placeholder-block">{icon('home')}<span>Team Photo</span></div>
    </div>
